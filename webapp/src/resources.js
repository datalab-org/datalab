...
export const API_URL =
  import.meta.env.VUE_APP_API_URL != null
    ? import.meta.env.VUE_APP_API_URL
    : "http://localhost:5001";
export const API_TOKEN = import.meta.env.VUE_APP_API_TOKEN;

export const QR_CODE_RESOLVER_URL = import.meta.env.VUE_APP_QR_CODE_RESOLVER_URL;

export const FEDERATION_QR_CODE_RESOLVER_URL = "https://purl.datalab-org.io";

export const LOGO_URL = import.meta.env.VUE_APP_LOGO_URL;
export const HOMEPAGE_URL = import.meta.env.VUE_APP_HOMEPAGE_URL;
export const APP_VERSION = import.meta.env.VUE_APP_GIT_VERSION;
...
const editable_inventory = import.meta.env.VUE_APP_EDITABLE_INVENTORY || "false";
...
export const UPPY_MAX_TOTAL_FILE_SIZE =
  Number(import.meta.env.VUE_APP_UPPY_MAX_TOTAL_FILE_SIZE) != null
    ? import.meta.env.VUE_APP_UPPY_MAX_TOTAL_FILE_SIZE
    : 102400000000;
export const UPPY_MAX_NUMBER_OF_FILES =
  Number(import.meta.env.VUE_APP_UPPY_MAX_NUMBER_OF_FILES) != null
    ? import.meta.env.VUE_APP_UPPY_MAX_NUMBER_OF_FILES
    : 10000;
