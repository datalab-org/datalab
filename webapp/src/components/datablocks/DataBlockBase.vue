...
export default {
  ...
  mounted() {
    ...
    this.$refs.thisDataBlock.addEventListener("block-event", this.handleBokehEvent);
  },
  beforeUnmount() {
    this.$refs.thisDataBlock.removeEventListener("block-event", this.handleBokehEvent);
  },
  methods: {
    async updateBlock() {
