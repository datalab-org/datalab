   ...
   <div class="modal-enclosure">
      <Modal v-model="fileSelectModalIsOpen">
         <template v-slot:header>
            Select files to add 
            <button @click="fetchRemoteTree" :disabled="isLoadingRemoteTree" class="ml-4 btn btn-small btn-default">
         ...
         <template v-slot:footer>
            ...
            <button type="button" class="btn  btn-secondary" data-dismiss="modal" @click="fileSelectModalIsOpen = false">Close</button>
         </template>
      </Modal>
   </div>
</template>
...
import {fetchRemoteTree, fetchCachedRemoteTree, addRemoteFileToSample} from "@/server_fetch_utils"
