      ...
      <template #body>
        ...
        <div class="form-row">
          <div class="col-md-12 form-group">
            ...
            <UserSelect v-model="managers" aria-labelledby="editGroupAdminsLabel" multiple />
          </div>
        </div>
        <div class="form-row">
          <div class="col-md-12 form-group">
    ...
    group: {
      ...
      handler(newGroup) {
        if (newGroup) {
          ...
          this.managers = newGroup.managers || [];
          this.group_members = newGroup.members || [];

          this.originalGroup = { ...newGroup };
          this.originalAdmins = [...this.managers];
  ...
  methods: {
    async submitForm() {
      ...
      const groupData = {
        ...
        managers: this.managers.map((admin) => admin.immutable_id),
      };
