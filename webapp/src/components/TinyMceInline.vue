<template>
	...
	:init='{
		...
		toolbar: "bold italic underline strikethrough superscript subscript forecolor backcolor removeformat | 		alignleft aligncenter alignright | bullist numlist indent outdent | headergroup insertgroup | table",
		toolbar_groups: {
				formatgroup: {
				icon: "format",
				tooltip: "Formatting",
