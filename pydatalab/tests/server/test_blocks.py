...
def test_xrd_block_lifecycle(admin_client, default_sample_dict):
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("nmr", "NMR/1.zip"),
        # ("raman", "raman/raman_example.txt"),  # disable Raman temporarily; it raises warnings by default which pytest captures as errors
        ("ms", "TGA-MS/20221128 134958 TGA MS Megan.asc"),
        ("xrd", "XRD/Scan_C4.xrdml"),
        ("media", "media/grey_group_logo.jpeg"),
    ],
)
