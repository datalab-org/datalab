...
def read_jeol_jdf_1d(filename: str | Path) -> tuple[pd.DataFrame, dict, str, tuple[int, ...]]:
    """Read a JEOL .jdf file and return it as a dataframe with
    any associated metadata. Developed by analogy with the Bruker/JCAMP readers
